...
const PreviewEditor = require("./preview-editor");
const FilterEditor = require("./filter-editor");
...
module.exports = new Class({
  ...
  initEvents: function() {
    ...
    this.modeButtons.each(
      function(button) {
        button.addEvent(
          "click",
          this.setMode.bind(this, button.getAttribute("data-mode"))
        );
      }.bind(this)
    );
  },
